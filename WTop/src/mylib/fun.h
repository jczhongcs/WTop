...
namespace mylib {
    namespace fun {
        void ZScoreNormalize(std::vector<double> &signals, double *avg, double *stdev);
...
//-- Dynamic Time Warping --//
        double DynamicTimeWarping_global(const std::vector<double> &seq1, const std::vector<double> &seq2,
                                         std::vector<std::pair<long, long> > &alignment);

        double DynamicTimeWarping_local(const std::vector<double> &seq1, const std::vector<double> &seq2,
                                        std::vector<std::pair<long, long> > &alignment);

        double DynamicTimeWarping(const std::vector<double> &seq1, const std::vector<double> &seq2,
                                  std::vector<std::pair<long, long> > &alignment);

//-- constrained (bound) DTW --//
        double BoundDynamicTimeWarping(const std::vector<double> &seq1, const std::vector<double> &seq2,
                                       const std::vector<std::pair<long, long> > &bound,
                                       std::vector<std::pair<long, long> > &alignment);

/** Left path is blocked*/
        double BoundDynamicTimeWarpingR(const std::vector<double> &seq1, const std::vector<double> &seq2,
                                        const std::vector<std::pair<long, long> > &bound,
                                        std::vector<std::pair<long, long> > &alignment);

        void combine(const vector<double> &ref, const vector<double> &peer, vector<double> &signal);

        void splite(const vector<double> &ref, const vector<double> &peer, vector<double> &signal,
